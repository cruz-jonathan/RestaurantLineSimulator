...
public class Bacon : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (timer >= cookedTime)
        {
            this.transform.tag = "Bacon";
            bacon1.GetComponent<Renderer>().material = cookedMaterial1;
            bacon2.GetComponent<Renderer>().material = cookedMaterial2;
